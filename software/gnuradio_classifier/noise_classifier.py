...
class noise_classifier(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "noise_classifier")
        ...
        self.connect((self.dnn_dnn_onnx_sync_0_0, 0), (self.qtgui_vector_sink_f_0, 0))
...
def main(top_block_cls=noise_classifier, options=None):
