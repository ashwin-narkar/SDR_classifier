...
class testdnn(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testdnn")
        ...
        self.dnn_dnn_onnx_sync_0 = dnn.dnn_onnx_sync('', 100, 'CPU')
        ...
        self.connect((self.dnn_dnn_onnx_sync_0, 0), (self.blocks_vector_to_stream_0, 0))
...
def main(top_block_cls=testdnn, options=None):
