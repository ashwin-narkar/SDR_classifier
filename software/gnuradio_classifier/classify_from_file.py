...
class classify_from_file(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "classify_from_file")
        ...
        self.freq_xlating_fir_filter_xxx_0_0 = filter.freq_xlating_fir_filter_ccc(2, firdes.complex_band_pass(1, samp_rate, -samp_rate/(2), samp_rate/(2), 1e5), 2426.5e6, samp_rate)
        ...
        self.dnn_dnn_onnx_sync_0_0 = dnn.dnn_onnx_sync('/home/ashwin/Documents/Capstone/data/lstm_iq.onnx', 1, 'CPU')
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/ashwin/Documents/Capstone/software/gnuradio_wifi_scanner/rawwifisignal.bin', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, -self.samp_rate/(2), self.samp_rate/(2), 1e5))
...
def main(top_block_cls=classify_from_file, options=None):
