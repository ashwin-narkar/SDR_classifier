...
class bluetooth_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0_0.set_center_freq(2.426e9, 0)
        self.uhd_usrp_source_0_0.set_antenna("TX/RX", 0)
        self.uhd_usrp_source_0_0.set_gain(0.4, 0)
        ...
        self.qtgui_number_sink_1.set_title("Packed")
        ...
        self.freq_xlating_fir_filter_xxx_0_0 = filter.freq_xlating_fir_filter_ccc(2, firdes.complex_band_pass(1, samp_rate, -1e6/2, 1e6/2, 1e5), 2.426e9, samp_rate)
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.qtgui_number_sink_1, 0))
        ...
        self.connect((self.freq_xlating_fir_filter_xxx_0_0, 0), (self.digital_gfsk_demod_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, -1e6/2, 1e6/2, 1e5))
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(2.426e9, self.samp_rate)
