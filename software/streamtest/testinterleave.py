...
class testinterleave(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testinterleave")
        ...
        self.qtgui_vector_sink_f_2.set_y_axis(-2, 2)
        ...
        self.qtgui_vector_sink_f_1.set_y_axis(-2, 2)
        ...
        self.qtgui_vector_sink_f_0.set_y_axis(-2, 2)
        ...
        self.blocks_stream_to_vector_2 = blocks.stream_to_vector(gr.sizeof_float*1, 256)
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_float*1, 128)
        ...
        self.blocks_add_const_vxx_0 = blocks.add_const_vff([0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5])
        ...
        self.connect((self.analog_const_source_x_1, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_vector_to_stream_1, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.qtgui_vector_sink_f_1, 0))
        self.connect((self.blocks_interleave_0, 0), (self.blocks_stream_to_vector_2, 0))
        ...
        self.connect((self.blocks_stream_to_vector_1, 0), (self.blocks_add_const_vxx_0, 0))
        self.connect((self.blocks_stream_to_vector_2, 0), (self.qtgui_vector_sink_f_2, 0))
        self.connect((self.blocks_vector_to_stream_0, 0), (self.blocks_interleave_0, 1))
...
def main(top_block_cls=testinterleave, options=None):
