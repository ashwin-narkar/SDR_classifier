...
class test_xlating_filter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_xlating_filter")
        ...
        self.freq = freq = 2.4265e9

        ##################################################
        # Blocks
        ##################################################
        self._freq_range = Range(2.4165e9, 2.4365e9, 1e6, 2.4265e9, 200)
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.complex_band_pass(1, samp_rate, -samp_rate/4,samp_rate/4, 1e5), freq, samp_rate)
...
def main(top_block_cls=test_xlating_filter, options=None):
